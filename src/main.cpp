...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy;
    if (nHeight < 21) {
        nSubsidy = 100000 * COIN; // 2M DSC Premine
    }
    else {
        nSubsidy = 5 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if (nHeight < 18721) {
        nSubsidy = 10 * COIN;
    }
    else if (nHeight < 23041) {
        nSubsidy = 12 * COIN;
    }
    else if (nHeight < 27361) {
        nSubsidy = 14 * COIN;
    }
    else if (nHeight < 31681) {
        nSubsidy = 16 * COIN;
    }
    else if (nHeight < 36001) {
        nSubsidy = 18 * COIN;
    }
    ...
    else if (nHeight < 129601) {
        nSubsidy = 26 * COIN;
    }
    else if (nHeight < 172801) {
        nSubsidy = 28 * COIN;
    }
    else if (nHeight < 302401) {
        nSubsidy = 30 * COIN;
    }
    else if (nHeight < 432001) {
        nSubsidy = 32 * COIN;
    }
    else if (nHeight < 777601) {
        nSubsidy = 30 * COIN;
    }
    else if (nHeight < 2160001) {
        nSubsidy = 10 * COIN;
    }
    else if (nHeight < 4320001) {
        nSubsidy = 3 * COIN;
    }
    else if (nHeight < 8640001) {
        nSubsidy = 1 * COIN;
    }
    else {
        nSubsidy = 0 * COIN;
...
{
    RenameThread("DiscountCoin-loadblk");
