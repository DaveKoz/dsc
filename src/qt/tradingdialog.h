...
private slots:
    ...
    QString BuyDSC(QString OrderType, double Quantity, double Rate);
    QString SellDSC(QString OrderType, double Quantity, double Rate);
