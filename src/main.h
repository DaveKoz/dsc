...
static const int64_t STATIC_POS_REWARD = 5 * COIN; //Constant reward of 8 DSC per COIN i.e. 5%
...
static const int64_t MAX_MONEY = 50000000 * COIN;  // 50M COIN
...
inline int64_t GetMNCollateral(int nHeight) { return 5000; } // 5000 DSC for 1 Masternode
